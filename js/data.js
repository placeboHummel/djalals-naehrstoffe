...
export const MY_SUPPLEMENTS = [
  {
    ...
    pillCount: 1,
    pillUnit: 'Kapsel',
    pillVisual: 'Pflanzliche HPMC-Kapsel (Hellbraun)',
    icon: '☀️',
    badge: '21 Nährstoffe',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Kapsel',
    pillVisual: 'Kleine Ölkapsel (Klar/Goldgelb)',
    icon: '☀️',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Kapsel',
    pillVisual: 'Weiße Kapsel (Calciumascorbat)',
    icon: '🍊',
  ...
  },
  {
    ...
    timing: 'Block A – Frühstück mit Fettquelle',
    block: 'A',
    compartment: 'liquid_powder',
    inOrganizer: false,
    pillCount: 10,
    pillUnit: 'ml (flüssig)',
    pillVisual: 'Flüssiges Wildfischöl & Polyphenole (Flasche)',
    icon: '🐟',
  ...
  },
  {
    ...
    pillCount: 3,
    pillUnit: 'Kapseln',
    pillVisual: 'Weiße Cholinbitartrat-Kapseln (3 Stück)',
    icon: '🧠',
    badge: '450 mg Cholin',
  ...
  },
  {
    ...
    pillCount: 3,
    pillUnit: 'Kapseln',
    pillVisual: 'Große weiße Bisglycinat-Kapseln (3 Stück)',
    icon: '🌙',
  ...
  },
  {
    ...
    timing: 'Im Protein-Shake (Post-Workout / Nachmittags)',
    block: 'shake',
    compartment: 'liquid_powder',
    inOrganizer: false,
    pillCount: 1,
    pillUnit: 'Messlöffel (3,4 g)',
    pillVisual: 'Feinstes weißes Creapure® Pulver',
    icon: '⚡',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Shake (30 g)',
    pillVisual: 'Cremiges Proteinpulver (Lemon Cheesecake)',
    icon: '🍋',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Softgel',
    pillVisual: 'Tief dunkelrote Softgel-Kapsel (AstaPure®)',
    icon: '🔴',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Kapsel',
    pillVisual: 'Gelb-orangene CoQ10-Kapsel',
    icon: '🔋',
  ...
  },
  {
    ...
    pillCountEvening: 1,
    pillUnit: 'Tabletten',
    pillVisual: 'Weiße Kompakttablette (1x früh, 1x spät)',
    icon: '🦴',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Kapsel',
    pillVisual: 'Weiße Kapsel (500 mg ALCAR)',
    icon: '⚡',
    badge: '500 mg ALCAR',
  ...
  },
  {
    ...
    inOrganizer: false,
    pillCount: 1,
    pillUnit: 'Messlöffel (5 g)',
    pillVisual: 'Süßliches weißes L-Glycin Pulver (im Wasserglas)',
    icon: '✨',
  ...
  },
  {
    ...
    pillCount: 1,
    pillUnit: 'Kapsel',
    pillVisual: 'Transparente Kapsel mit weißem Hyaluronat',
    icon: '💧',
  ...
  },
  {
    ...
    pillCount: 2,
    pillUnit: 'Kapseln',
    pillVisual: 'Weiße Kapseln (>99,9% reines Taurin, 2 Stück)',
    icon: '⚡',
