...
export const NUTRIENT_DETAILS = {
  ...
  'calcium': {
    id: 'calcium',
    name: 'Calcium',
    scientificName: 'Calciumcarbonat / -citrat',
    categoryName: 'Mineralstoffe & Spurenelemente',
    badge: '⛰️ Mengenelement',
    summary: 'Hauptmineral für Knochen- und Zahnmatrix, neuromuskuläre Reizübertragung und Blutgerinnungskaskade.',
    ...
    plantBasedRelevance: 'Watson Male Essentials liefert moderate 120 mg, um die Grundversorgung zu stützen, ohne die enterale Resorption von Zink und Eisen über Transporter-Konkurrenz (DMT-1) zu blockieren.',
    intakeAdvice: 'Nicht in sehr hohen Dosen zeitgleich mit Zink oder Eisen einnehmen.',
    safetyAndUL: 'EFSA Upper Limit: 2.500 mg/Tag.',
    scientificReference: 'EFSA Journal 2015;13(5):4101 | D-A-CH Referenzwerte'
  },
  'magnesium': {
    id: 'magnesium',
    name: 'Magnesium',
  ...
  'carnitine': {
    id: 'carnitine',
    name: 'L-Carnitin',
    scientificName: 'L-Carnitin / Acetyl-L-Carnitin (0 mg - Offen)',
    categoryName: 'Aminosäuren, Omega-3 & Performance',
    badge: '🔥 Mitochondriale Fettverbrennung',
    summary: 'Bedingt essentielle Aminosäurenverbindung – transportiert langkettige Fettsäuren in die Mitochondrien zur Beta-Oxidation.',
    biochemistry: 'L-Carnitin bindet über die Carnitin-Palmitoyl-Transferase-1 (CPT-1) an aktivierte Fettsäuren und schleust sie durch die innere Mitochondrienmembran zur ATP-Gewinnung. Acetyl-L-Carnitin (ALCAR) überwindet zudem die Blut-Hirn-Schranke.',
    plantBasedRelevance: '95% des körpereigenen Carnitinpools stammen bei Mischköstlern aus rotem Fleisch. Bei Nicht-Fleischessern sind die Carnitinspiegel im Blut und Muskel um bis zu 40-50% erniedrigt, da die Eigensynthese aus Lysin und Methionin limitiert ist.',
    intakeAdvice: 'Morgens oder vor dem Training mit Kohlenhydraten (Insulin fördert die muskuläre Aufnahme) einnehmen.',
    safetyAndUL: 'EFSA Tolerable Upper Limit: 2.000 mg/Tag. Eine Ergänzung von 500-1.000 mg ist für Nicht-Fleischesser optimal.',
    scientificReference: 'American Journal of Clinical Nutrition | Journal of Physiology'
  },
  'taurine': {
    id: 'taurine',
    name: 'Taurin',
  ...
  'coq10': {
    ...
    scientificName: 'Ubiquinol / Coenzym Q10 (0 mg - Offen)',
    categoryName: 'Aminosäuren, Omega-3 & Performance',
    badge: '🔋 Mitochondriale ATP-Atmungskette',
    summary: 'Unverzichtbarer Elektronenüberträger in den Komplexen I/II zu III der Atmungskette und starkes lipidlösliches Antioxidans.',
    biochemistry: 'Ubiquinol nimmt Elektronen aus der Oxidation von Glukose und Fettsäuren auf und überträgt sie in der inneren Mitochondrienmembran, um den Protonengradienten für die ATP-Synthetase aufzubauen. In reduzierter Form schützt es Membranen vor Peroxidation.',
    plantBasedRelevance: 'Die höchsten alimentären Quellen sind tierische Organe (Herz, Leber) und fetter Fisch. Pflanzliche Quellen liefern nur vernachlässigbare Spuren. Ab dem 30. Lebensjahr sinkt die Eigensynthese stetig.',
    intakeAdvice: 'Fettlöslich: Zu einer Mahlzeit einnehmen. Die reduzierte Form Ubiquinol besitzt eine 3- bis 4-fach höhere Bioverfügbarkeit als Ubichinon.',
    safetyAndUL: 'EFSA bewertet 100-300 mg/Tag als völlig unbedenklich. 100 mg ist die ideale Zieldosis.',
    scientificReference: 'BioFactors Journal 2018 | Journal of Clinical Biochemistry and Nutrition'
  },
  'nac': {
    id: 'nac',
  ...
  'astaxanthin': {
    id: 'astaxanthin',
    name: 'Astaxanthin',
    scientificName: 'Natürliches Astaxanthin (aus Haematococcus pluvialis) (0 mg - Offen)',
    categoryName: 'Aminosäuren, Omega-3 & Performance',
    badge: '👁️ Blut-Hirn-Schranke & Zellschutz',
    summary: 'Das stärkste bekannte Carotinoid-Antioxidans – durchspannt die gesamte Zellmembran und schützt Augen, Gehirn und Haut.',
    biochemistry: 'Astaxanthin besitzt eine polare Doppelstruktur, die sich exakt quer durch die Lipiddoppelschicht der Zellmembran legt. Es überwindet die Blut-Hirn- und Blut-Netzhaut-Schranke und neutralisiert Singulett-Sauerstoff bis zu 6.000-mal effektiver als Vitamin C.',
    plantBasedRelevance: 'In der Nahrung kommt Astaxanthin ausschließlich in Lachs, Forelle und Krustentieren vor (die es über Algen anreichern). Für Nicht-Fischesser ist natürliches Algen-Astaxanthin (4-8 mg) eine herausragende Ergänzung.',
    intakeAdvice: 'Fettlöslich: Zu einer fetthaltigen Mahlzeit oder gemeinsam mit Omega-3 Öl einnehmen.',
    safetyAndUL: 'EFSA bestätigt die Sicherheit von 8 mg natürlichem Astaxanthin pro Tag für Erwachsene.',
    scientificReference: 'EFSA Journal 2020;18(2):5993 | Marine Drugs Journal'
  },
  'ala': {
    id: 'ala',
  ...
  'prolin': {
    id: 'prolin',
    name: 'L-Prolin',
    scientificName: 'L-Prolin (0 mg - Offen)',
    categoryName: 'Aminosäuren, Omega-3 & Performance',
    ...
    plantBasedRelevance: 'Da echte Gelatine und tierisches Bindegewebe nicht konsumiert werden, unterstützt die Zufuhr von pflanzlich fermentiertem L-Prolin (500 mg) im Verbund mit Glycin die körpereigene Kollagensynthese optimal.',
    intakeAdvice: 'Gemeinsam mit Glycin (CollaSyn®) und Vitamin C morgens oder vor dem Training.',
    safetyAndUL: 'Natürliche Proteinkomponente mit uneingeschränkter Sicherheit.',
    scientificReference: 'Journal of Biological Chemistry | Matrix Biology'
  },
  'ps': {
    id: 'ps',
